            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.l10n.permissionsDescription(app.name),
                        style: Theme.of(
                          context,
                ...
                Container(
                  ...
                  child: Text(
                    app.sandboxLabel.toLowerCase() == 'user'
                        ? context.l10n.userInstallation
                        : context.l10n.systemInstallation,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                for (
                  var sectionIndex = 0;
                  sectionIndex < app.permissionSections.length;
                  sectionIndex++
                ) ...[
                  PermissionSection(
